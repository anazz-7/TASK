...
window.__exportLabelReportPDF = function() {
  ...
  const printHtml = `
    ...
    <body>
      <div class="header">
        <h1>${bizName}</h1>
        <p>LABELLING PRODUCTION &amp; QUANTITY REPORT</p>
      </div>

      <div class="meta-bar">
        <span><b>Report Type:</b> Visual Labelling Log</span>
...
window.__exportPackageReportPDF = function() {
  ...
  const printHtml = `
    ...
    <body>
      <div class="header">
        <h1>${bizName}</h1>
        <p>PACKAGING PRODUCTION &amp; QUANTITY REPORT</p>
      </div>

      <div class="meta-bar">
        <span><b>Report Type:</b> Visual Packaging Log</span>
        <span><b>Export Date:</b> ${exportDate}</span>
        <span><b>Generated By:</b> ${esc(session.name)} (${session.role})</span>
      </div>
